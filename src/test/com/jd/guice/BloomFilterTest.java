...
public class BloomFilterTest {
    ...
    public void testCreateHash_String() throws Exception {
        ...
        int result1 = (int) BloomFilter.createHash(val);
        int result2 = (int) BloomFilter.createHash(val);
        assertEquals(result2, result1);
        int result3 = (int) BloomFilter.createHash(UUID.randomUUID().toString());
        assertNotSame(result3, result2);

        int result4 = (int) BloomFilter.createHash(val.getBytes("UTF-8"));
    ...
    public void testCreateHash_byteArr() throws UnsupportedEncodingException {
        ...
        int result1 = (int) BloomFilter.createHash(data);
        int result2 = (int) BloomFilter.createHash(val);
